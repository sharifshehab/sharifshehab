...
<p align="left">Hello, I'm Sharif Shehab.MERN stack developer with a strong foundation in React.js, Node.js, Express.js, MongoDB, and REST API development. 
Hands-on experience in building responsive, user-friendly interfaces with shared components, managing global state throughout the application using Context API, and efﬁciently handling server-side management and HTTP requests 
